...
public class DriveTrain extends OutliersSubsystem {
    ...
    public DriveTrain(
        ...
        _trajectoryController = new PPHolonomicDriveController(
                new PIDController(Constants.DriveTrain.X_POSE_TRAJECTORY_kP, Constants.DriveTrain.X_POSE_TRAJECTORY_kI, Constants.DriveTrain.X_POSE_TRAJECTORY_kD),
                new PIDController(Constants.DriveTrain.Y_POSE_TRAJECTORY_kP, Constants.DriveTrain.Y_POSE_TRAJECTORY_kI, Constants.DriveTrain.Y_POSE_TRAJECTORY_kD),
