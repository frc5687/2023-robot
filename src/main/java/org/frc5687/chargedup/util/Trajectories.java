...
public class Trajectories {
    ...
    private static final List<Pair<String, PathConstraints>> paths = new ArrayList<>(Arrays.asList(
            ...
            new Pair<>("RED_NODE_TWO_GOAL_TWO_LINE", new PathConstraints(2.5, 2.5)),
            new Pair<>("BLUE_NODE_ONE_GOAL_ONE_SHOOT", new PathConstraints(3.5, 2.5)),
            new Pair<>("BLUE_NODE_TWO_GOAL_TWO_LINE", new PathConstraints(3.5, 2.5))
    ));
