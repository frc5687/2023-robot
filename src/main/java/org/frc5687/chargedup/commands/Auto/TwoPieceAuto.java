                ...
                if (DriverStation.getAlliance() == Alliance.Red) {
                    ...
                    _trajectory1 =
                            TrajectoryGenerator.generateTrajectory(
                                    Constants.Auto.TrajectoryPoints.Node1.RED_NODE_ONE_TRAJECTORY_ONE, config);
                    _trajectory2 =
                            TrajectoryGenerator.generateTrajectory(
                                    Constants.Auto.TrajectoryPoints.Node1.RED_NODE_ONE_TRAJECTORY_TWO, config);
                } else {
        ...
        addCommands(
                new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                new DriveTrajectory(driveTrain, _trajectory1), new AutoIntake(_shooter)),
