          ...
          switch(_node) {
            case OneCone:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_ONE_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_ONE_GOAL);
            ...
            case TwoCube:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_TWO_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_TWO_GOAL);
            ...
            case ThreeCone:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_THREE_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_THREE_GOAL);
            ...
            case FourCone:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_FOUR_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_FOUR_GOAL);
            ...
            case FiveCube:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_FIVE_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_FIVE_GOAL);
            ...
            case SixCone:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_SIX_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_SIX_GOAL);
            ...
            case SevenCone:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_SEVEN_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_SEVEN_GOAL);
            ...
            case EightCube:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_EIGHT_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_EIGHT_GOAL);
            ...
            case NineCone:
                if (DriverStation.getAlliance() == Alliance.Red){
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.RED_NODE_NINE_GOAL);
                    ...
                    driveTrain.resetOdometry(Constants.Auto.FieldPoses.BLUE_NODE_NINE_GOAL);
