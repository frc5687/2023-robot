...
public class SemiAutoPickupCone extends SequentialCommandGroup {
    public SemiAutoPickupCone(Arm arm, EndEffector endEffector, Elevator elevator, OI oi) {
        ...
        addCommands(
                ...
                new ParallelDeadlineGroup(
                        new WaitForManualGripper(endEffector, oi, false), new HoldArm(arm, setpoint.armAngle)),
